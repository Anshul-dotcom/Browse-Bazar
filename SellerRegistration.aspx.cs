...
public partial class SellerRegistration : Page
{
    ...
    protected void VerifyOtpButton_Click(object sender, EventArgs e)
    {
        ...
        if (enteredOtp == lblotp.Text)
        {
            ...
            string ifscCode = IfscCode.Text.Trim();
            ...
            {
                string query = "INSERT INTO Seller (EmailId, FirstName, LastName, PhoneNumber, IFSCCode, Address, Password,Type) " +
                               "VALUES (@EmailId, @FirstName, @LastName, @PhoneNumber, @IFSCCode, @Address, @Password,@Type)";
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@Type", "Seller");
    ...
    private void GenerateAndSendOtp()
    {
        ...
        lblotp.Text = OTP.Next(1000, 9999).ToString();
        ...
        try
        {
            ...
            mail.Body = "Dear " + FirstName.Text + ",\nYour OTP for Seller registration is " + lblotp.Text + ".\nThank you,\nBrowse Bazar Admin";
