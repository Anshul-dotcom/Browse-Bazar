...
<body>
    ...
    <ul class="category-list">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="Product_ID" DataSourceID="View_ProductDataSource1" OnItemCommand="ListView1_RowCommand" OnSelectedIndexChanged="ListView1_SelectedIndexChanged">
            <LayoutTemplate>
        ...
        <asp:SqlDataSource 
            ...
            <footer class="footer">
                <div class="footer-content">
                    <p>&copy; 2024 Browse Bazar. All rights reserved.</p>
                </div>
            </footer>
