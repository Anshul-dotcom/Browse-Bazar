...
public partial class CustomerRegistration : Page
{
    ...
    protected void VerifyOtpButton_Click(object sender, EventArgs e)
    {
        ...
        if (enteredOtp == lblotp.Text) 
        {
            ...
            {
                string query = "INSERT INTO Customer (EmailId, FirstName, LastName, PhoneNumber, Address, Password, Type) " +
                               "VALUES (@EmailId, @FirstName, @LastName, @PhoneNumber, @Address, @Password, @Type)";
    ...
    private void GenerateAndSendOtp()
    {
        ...
        try
        {
            ...
            mail.Body = "Dear " + FirstName.Text + ",\nYour OTP for Customer registration is " + lblotp.Text + ".\nThank you,\nBrowse Bazar Admin";
